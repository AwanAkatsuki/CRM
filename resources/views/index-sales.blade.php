...
<div>
    ...
    <!-- Notification -->
    <div>
        <button type="button" class="btn putih btn-sm shadow font-weight-bold">Report</button>
        <button type="button" class="btn putih btn-sm shadow font-weight-bold mx-3">Sample</button>
    </div>
